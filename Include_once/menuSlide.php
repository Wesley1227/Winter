<div class="wui-side-menu open pinned" data-wui-theme="dark">
    ...
    <form action="../Include_once/inserirFiltros.php" method="GET">
            ...
            ?>
            Preço:<br>
            <input type="number" id="search-bar" class="preco" name="precoMin" placeholder="<?php echo $precoMinimo ?>">
            <input type="number" id="search-bar" class="preco" name="precoMax" placeholder="<?php echo $precoMaximo ?>">
