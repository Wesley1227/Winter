...
if ($idUser2 == null || $idUser2 == 0) {
    ...
    exit; // Sempre finalize a execução após redirecionar
}
...
if ($idAnuncio == null) {
    echo '<div id="escolhe1">👈🧑‍🦱 <br> Escolhe um</div>';
}
...
?>
        <div id="mensagem" style="<?php echo $style ?>">
            ...
            ?>
            <?php echo $chat['nome'] ?><div class="status"><?= $status ?></div> 
            <?php echo $chat['mensagem'] ?><br>
...
<div style="margin-top: 10px;">
                <a href="../include_once/Mensagens/avaliacao.php?idUser=<?= $idUser2 ?>&idAnuncio=<?= $idAnuncio ?>"><button style="background: none;">Avaliar</button></a>
            </div>
<div class="alertChat">
