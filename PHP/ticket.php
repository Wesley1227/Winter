...
<body>
    <div id="ticket">
        ...
        <div class="menuHistorico">
            <a href="ticket.php?assunto=1"> <button class="custom-btn" style="width: 100%;" id="<?php if ($assunto == "1") {
                                                                                                    echo "btn_ticket2";
                                                                                                } ?>">Pedir edição de dados pessoais</button></a>
            <a href="ticket.php?assunto=2"> <button class="custom-btn" style="width: 100%;" id="<?php if ($assunto == "2") {
                                                                                                    echo "btn_ticket2";
                                                                                                } ?>">Pedir remoção de conta</button </a>
                <a href="ticket.php?assunto=3"> <button class="custom-btn" style="width: 100%;" id="<?php if ($assunto == "3") {
                                                                                                        echo "btn_ticket2";
